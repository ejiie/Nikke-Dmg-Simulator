...
| `etl/roledata_cleaner.py` | `blabla_roledata.json` → `roledata_clean.json` | 공식 roledata 정제. basicAttack 단위변환(damage/100 등) + element/weapon/manufacturer/burst 정규화. **name_code 키** |
